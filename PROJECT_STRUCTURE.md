...
├── test_promptguard.py            # Unit tests for the core system
...
### 1. [detector.py](file:///c:/Users/LENOVO/OneDrive/Desktop/assdc/promptguard/detector.py)
...
### 2. [risk_scorer.py](file:///c:/Users/LENOVO/OneDrive/Desktop/assdc/promptguard/risk_scorer.py)
- Calculates risk scores using weighted model (0-100 scale)
- Applies severity multipliers based on number of matches
- Generates human-readable explanations

### 3. [mitigation_engine.py](file:///c:/Users/LENOVO/OneDrive/Desktop/assdc/promptguard/mitigation_engine.py)
...
### 4. [app.py](file:///c:/Users/LENOVO/OneDrive/Desktop/assdc/promptguard/app.py)
...
- Run `python test_promptguard.py` for unit tests
