"""
Comprehensive demonstration of the PromptGuard system
"""
from mitigation_engine import MitigationEngine

def demonstrate_system():
    """Demonstrate the complete PromptGuard system"""
    print("=" * 60)
    print("PROMPTGUARD - ANTI-PROMPT INJECTION DEFENSE FRAMEWORK")
    print("=" * 60)
    print()
    ...
    print("TESTING PROMPTGUARD SYSTEM")
    print("-" * 40)
    ...
    print("PromptGuard successfully protects against prompt injection attacks")
